...
public class FileStorageService {
	...
	public String storeFile(MultipartFile file, UserPrincipal currentUser) {
		...
		newFileName = new Date().getTime() + "-" + file.getOriginalFilename().replace(" ", "_");// currentUser.getUsername()+fileExtension;
	...
	public String storeFileAvatar(MultipartFile file, UserPrincipal currentUser) {
		String fileName = StringUtils.cleanPath(file.getOriginalFilename());
		String newFileName = "";
		try {
			if (fileName.contains("..")) {
